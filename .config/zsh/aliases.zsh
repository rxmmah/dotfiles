...
alias mountexfat='doas mount -t exfat -o uid=$(id -u kira),gid=$(id -g kira),rw'
alias rsync='rsync --verbose --archive --info=progress2 --human-readable --partial'
alias tree='tree -a -I .git --dirsfirst'
alias deezer='deemix -b flac'
alias yt='yt-dlp --external-downloader aria2c --embed-chapters --sponsorblock-mark all'
...
# files
alias vif="fzf --multi --bind 'enter:become(nvim {+})'"
alias mpvf="fd --extension mp4 --extension mkv --extension avi --extension mov --extension flv --extension wmv --extension mpg --extension mpeg | fzf --multi --bind 'enter:become(mpv {+})'"
...
alias uz='gzip -d' # uz <archive_decompress> -d <dir>
alias sr='source ~/.config/zsh/env.zsh'
alias ..="z .."
alias mkdir="mkdir -p"

## Xbps Pkg Manager
alias pi="paru -Slq | fzf -m --preview 'cat <(paru -Si {1}) <(paru -Fl {1} | awk \"{print \$2}\")' | xargs -ro  paru -S"
...
alias i="paru -S"
alias u="paru -Syyu;doas pacman -Syyu"
#ls
alias ls="exa --color=auto --icons"
alias ll="exa -l --color=auto --icons"
alias la="exa -a --color=auto --icons"
alias lla="exa -la --color=auto --icons"
...
alias lemgo='curl wttr.in/lemgo'
alias riyadh='curl wttr.in/riyadh'
